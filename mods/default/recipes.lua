...
c({
	output = 'default:platinum_rod 2',
	recipe = {{'default:platinum_ingot'}, {'default:platinum_ingot'}}
})

c({
	output = 'default:steel_rod 2',
	recipe = {{'default:steel_ingot'}, {'default:steel_ingot'}}
})

c({
	output = 'default:wood_rod 4',
	recipe = {{'default:planks'}, {'default:planks'}}
})

c({
	output = 'default:twig 4',
	recipe = {{'default:planks'}}
})

c({
	output = 'default:planks',
	recipe = {
...
c({
	output = "default:plank_slab",
	recipe = {
		{"default:plank_platform"},
		{"default:plank_platform"}
	}
})